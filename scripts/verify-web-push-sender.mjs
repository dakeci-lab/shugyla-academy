...
function stageStaticChecks() {
  ...
  assert('sender roles.assign_permissions permission', senderFn.includes('TEST_SEND_PERMIT_ISSUE_PERMISSION') || senderFn.includes("'roles.assign_permissions'"))
  assert('sender does not hardcode schedule.edit for issue', !senderFn.match(/TEST_SEND_PERMIT_ISSUE_PERMISSION\s*=\s*'schedule\.edit'/))
