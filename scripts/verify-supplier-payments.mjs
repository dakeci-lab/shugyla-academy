...
async function main() {
  ...
  const filterPopover = read('src/components/suppliers/settlements/SettlementsFilterPopover.jsx')
  assert.match(filterPopover, /createPortal/)
  assert.match(filterPopover, /document\.body/)
  assert.match(filterPopover, /settlements-filter-popover/)
  assert.doesNotMatch(filterPopover, /width: min\(360px, 100%\)/)
  const filterCss = read('src/components/suppliers/settlements/SettlementsFilterPopover.css')
