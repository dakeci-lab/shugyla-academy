...
const ROUTE_ACCESS = {
  ...
  [ROUTE_KEYS.FINANCES_GROUP]: [ROLE_IDS.ADMIN],
...
export function canAccessRoute(user, routeKey) {
  ...
  const routePermissionMap = {
    ...
    // «HR» is one nav entry with Кандидаты/Вакансии tabs (2026-09-20); each tab gates itself.
    [ROUTE_KEYS.HR_GROUP]: [
      P.RECRUITMENT_VIEW,
    ...
    [ROUTE_KEYS.FINANCES_GROUP]: [P.PAYMENT_ACCOUNTS_VIEW, P.PAYMENT_ACCOUNTS_MANAGE],
