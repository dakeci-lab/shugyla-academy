...
export function SortIcon({ size = 16, direction = 'neutral' }) {
  if (direction === 'asc') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
        <path d="M12 19V5" />
...
/** Двойная галочка — «прочитать все» */
export function CheckCheckIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function RotateCcwIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
